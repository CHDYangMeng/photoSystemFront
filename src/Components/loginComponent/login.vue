		...
		<div class="mui-content">
			<form id='login-form' class="mui-input-group">
				<div class="mui-input-row">
					<label>账号:</label>
					<input id='account' v-model="account" type="text" class="mui-input-clear mui-input" placeholder="请输入账号">
				</div>
			...
			<div class="mui-content-padded">
				<button id='login' type="button" @click="clickLogin" class="mui-btn mui-btn-block mui-btn-primary">登录</button>
...
export default {
  ...
  methods: {
    ...
    clickLogin() {
      this.$http.post('login-check',{account: this.account, password: this.password}).then(result => {
        console.log(result);
